...
- [ ] Automatic resize of admin interface
- [ ] Look into removing set shifter functions and only use insert_shifter instad
- [ ] Automatically load the check box values
- [ ] add setting for bpm references
- [ ] add password 
- [ ] make it possible to launch the admin interface from the webpage

  
* TODO Message Contents [7/9]
